...
const Navbar = () => {
  ...
  return (
    <div className="absolute top-0 left-0 w-full z-10 pt-5">
      ...
      {/* Mobile-Menu */}
       <div className={`md:hidden ${showMobileMenu ? 'fixed w-full': 'h-0 w-0'}  right-0 top-0 bottom-0 overflow-hidden bg-white transition-all`}>
        ...
        <ul className='flex flex-col items-center gap-2 px-5 text-lg'>
            ...
            <a href="" className='px-4 py-2 rounded-full inline-block'>Contact</a>
            <a href="" className='px-4 py-2 rounded-full inline-block'>Testomonials</a>
        </ul>
       </div>
    </div>
  )
